...
var echo_pb = createCommonjsModule(function (module, exports) {
// source: echo.proto
/**
 * @fileoverview
 * @enhanceable
...
goog.inherits(proto.echo.EchoRequest, googleProtobuf.Message);
...
goog.inherits(proto.echo.EchoResponse, googleProtobuf.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
